...
if __name__ == '__main__':
    ...
    cs = CandidateSelection(candidate_df=candidate_df, safety_df_size=len(safety_df), num_state_variables=num_state_variables,
                            num_actions=num_actions, num_features_size=num_features_size+1, theta_b=theta_b, safety_val=1.25)
    ...
    print(st(theta_c, theta_b, safety_val=0.46))
